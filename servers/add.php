...
//	//设置时区
//	date_default_timezone_set("PRC");
	$query = "INSERT INTO selllist(id,name,type1,intro,price1,price2,hasnum,buynum,pic,city) VALUES (NULL,'川大爷抽奖','抽奖','【东城区】川大爷免费抽奖, 一抽即中, 你抽我就送小姐姐一个!',9999,0,752,225,'/static/choujiang.jpg','北京')";
